...
class StringResultSet(
    ...
    override fun getBoolean(columnIndex: Int): Boolean {
        ...
        checkClosed()
        throw SQLException("Not a boolean column")
    }
    ...
    override fun getByte(columnIndex: Int): Byte {
        ...
        checkClosed()
        throw SQLException("Not a byte column")
    }
    ...
    override fun getShort(columnIndex: Int): Short {
        ...
        checkClosed()
        throw SQLException("Not a short column")
    }
    ...
    override fun getInt(columnIndex: Int): Int {
        ...
        checkClosed()
        throw SQLException("Not an int column")
    }
    ...
    override fun getLong(columnIndex: Int): Long {
        ...
        checkClosed()
        throw SQLException("Not a long column")
    }
    ...
    override fun getFloat(columnIndex: Int): Float {
        ...
        checkClosed()
        throw SQLException("Not a float column")
    }
    ...
    override fun getDouble(columnIndex: Int): Double {
        ...
        checkClosed()
        throw SQLException("Not a double column")
    }
    ...
    override fun getBigDecimal(columnIndex: Int, scale: Int): BigDecimal {
        ...
        checkClosed()
        throw SQLException("Not a BigDecimal column")
    }
    ...
    override fun getDate(columnIndex: Int): Date {
        ...
        checkClosed()
        throw SQLException("Not a Date column")
    }
    ...
    override fun getTime(columnIndex: Int): Time {
        ...
        checkClosed()
        throw SQLException("Not a Time column")
    }
    ...
    override fun getTimestamp(columnIndex: Int): Timestamp {
        ...
        checkClosed()
        throw SQLException("Not a Timestamp column")
    }
    ...
    override fun findColumn(columnLabel: String?): Int {
        ...
        return columns.indexOfFirst { c -> c.name == columnLabel }
    }
    ...
    override fun getURL(columnIndex: Int): URL {
        ...
        checkClosed()
        throw SQLException("Not a URL column")
    }
